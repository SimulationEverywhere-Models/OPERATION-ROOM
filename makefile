...
LDFLAGS+=-L. -g
#^|
EXAMPLESOBJS=  doctor.o equipment.o nurse.o operation.o register.o scheduler.o queue.o main.o generat.o cpu.o transduc.o distri.o com.o linpack.o debug.o trafico.o
#
...
#^|
doctor.o: /cygdrive/C/eclipse/workspace/VOperationRoom/doctor.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
equipment.o: /cygdrive/C/eclipse/workspace/VOperationRoom/equipment.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
nurse.o: /cygdrive/C/eclipse/workspace/VOperationRoom/nurse.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
operation.o: /cygdrive/C/eclipse/workspace/VOperationRoom/operation.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
register.o: /cygdrive/C/eclipse/workspace/VOperationRoom/register.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
scheduler.o: /cygdrive/C/eclipse/workspace/VOperationRoom/scheduler.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
#
...
#^|
doctor.o: /cygdrive/C/eclipse/workspace/VOperationRoom/doctor.cpp \
 /cygdrive/C/eclipse/workspace/VOperationRoom/doctor.h \
...
equipment.o: \
 /cygdrive/C/eclipse/workspace/VOperationRoom/equipment.cpp \
 /cygdrive/C/eclipse/workspace/VOperationRoom/equipment.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
nurse.o: /cygdrive/C/eclipse/workspace/VOperationRoom/nurse.cpp \
 /cygdrive/C/eclipse/workspace/VOperationRoom/nurse.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
operation.o: \
 /cygdrive/C/eclipse/workspace/VOperationRoom/operation.cpp \
 /cygdrive/C/eclipse/workspace/VOperationRoom/operation.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
...
register.o: /cygdrive/C/eclipse/workspace/VOperationRoom/register.cpp \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/portlist.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/workspace/VOperationRoom/scheduler.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/workspace/VOperationRoom/nurse.h \
 /cygdrive/C/eclipse/workspace/VOperationRoom/equipment.h \
 /cygdrive/C/eclipse/workspace/VOperationRoom/doctor.h \
 /cygdrive/C/eclipse/workspace/VOperationRoom/operation.h
scheduler.o: \
 /cygdrive/C/eclipse/workspace/VOperationRoom/scheduler.cpp \
 /cygdrive/C/eclipse/workspace/VOperationRoom/scheduler.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
